...
export default function Card({ creation, component, creationType }) {
  const Component = componentMap[component]
  return <Link to={`/movies-shows/${creationType + "/" + creation.id}`} className="carousel-card snap-start border-2 border-[#262626] bg-[#1A1A1A] p-6 rounded-lg">
      <img
